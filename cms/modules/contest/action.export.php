...
header('Content-Disposition: attachment;filename=contest-' . date('Y-m-d-h-i-s') . '.xls');
...
while($arr = $arrContact->fetch()){
	...
	unset($arr['type']);
	unset($arr['active']);
	$arr['bag_img'] = 'http://dugro.com.my/backpack/data/upload/game/' . $arr['bag_img'];
...
$result_content .= '<td nowrap bgcolor="#CCCCCC" style="font-weight:bold; height:25px; vertical-align:middle; margin:0px 0px 5px 5px; padding:0px 5px 0px 5px;" class=xl2216681>Like</td>';
$result_content .= '<td nowrap bgcolor="#CCCCCC" style="font-weight:bold; height:25px; vertical-align:middle; margin:0px 0px 5px 5px; padding:0px 5px 0px 5px;" class=xl2216681>Time</td>';
...
$result_content .= 					    '</tr>';
								            ...
								            $result_content .='<td nowrap style="height:25px; vertical-align:middle;margin:0px 0px 0px 5px;padding:0px 5px 0px 5px;" class=xl2216681>' . $arrTerm[$key]['vote'] . '</td>';
								            $result_content .='<td nowrap style="height:25px; vertical-align:middle;margin:0px 0px 0px 5px;padding:0px 5px 0px 5px;" class=xl2216681>' . $arrTerm[$key]['date'] . '</td>';
