...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="table_list table-Form1">
  <tr>
	...
	<th width="5%" class="th-name">Approved</th>
   	<th width="5%" class="th-name">UnApproved</th>
  ...
  <tr>
	...
	<td align="center"><a href="{LINK}&act=active&id={comment.id}"><img src="images/icons_default/status1.gif" width="10" height="10" border="0"></a></td>
   	<td align="center"><a href="{LINK}&act=inactive&id={comment.id}"><img src="images/icons_default/status0.gif" width="10" height="10" border="0"></a></td>
